...
\begin{document}
	...
	The introduction and \ref{sec:Beyond} were written by Matthew.  Tom wrote \ref{sec:LMC}, \ref{sec:MomentErrors} and \ref{subsec:future}.  Marko wrote \ref{sec:Imp}. Bowen wrote \ref{subsec:SGLD}
    ...
    \input{future} \label{subsec:future}
